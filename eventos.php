...
<div class="row">
	<article class="one-third block relative  column alpha">
			<figure>
				<img src="images/dummy/pousada_eventos1.jpg" class="scale-with-grid" alt="" />
			</figure>
	</article>

	<article class="one-third block relative column">
		<figure>
			<img src="images/dummy/pousada_eventos2.jpg" class="scale-with-grid" alt="" />
		</figure>
	</article>

	<article class="one-third block relative  column omega">
		<figure>
			<img src="images/dummy/pousada_eventos3.jpg" class="scale-with-grid" alt="" />
		</figure>
	</article>
</div>

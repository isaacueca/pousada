<div id="page-header" style="background:url(images/dummy/lazer_header.jpg) no-repeat center"></div>
...
<div class="row">
	<article class="one-third block relative  column alpha">
			<figure>
				<img src="images/dummy/pousada9.jpg" class="scale-with-grid" alt="" />
			</figure>
	</article>

	<article class="one-third block relative column">
		<figure>
			<img src="images/dummy/pousada8.jpg" class="scale-with-grid" alt="" />
		</figure>
	</article>
